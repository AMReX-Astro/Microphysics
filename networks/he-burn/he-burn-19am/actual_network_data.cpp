...
namespace NSE_INDEX
{
    AMREX_GPU_MANAGED amrex::Array2D<std::int8_t, 1, Rates::NumRates, 1, 7, amrex::Order::C> rate_indices {
        -1, 0, 2, -1, -1, 3, 61,  // p_C12_to_N13_reaclib
        -1, 1, 2, -1, -1, 5, 62,  // He4_C12_to_O16_reaclib
        -1, 1, 5, -1, -1, 6, 63,  // He4_O16_to_Ne20_reaclib
        -1, 1, 6, -1, -1, 8, 65,  // He4_Ne20_to_Mg24_reaclib
        -1, 0, 7, -1, -1, 8, 64,  // p_Na23_to_Mg24_reaclib
        -1, 1, 8, -1, -1, 10, 67,  // He4_Mg24_to_Si28_reaclib
        -1, 0, 9, -1, -1, 10, 66,  // p_Al27_to_Si28_reaclib
        -1, 1, 10, -1, -1, 12, 69,  // He4_Si28_to_S32_reaclib
        -1, 0, 11, -1, -1, 12, 68,  // p_P31_to_S32_reaclib
        -1, 2, 2, -1, 0, 7, -1,  // C12_C12_to_p_Na23_reaclib
        -1, 2, 2, -1, 1, 6, -1,  // C12_C12_to_He4_Ne20_reaclib
        -1, 1, 3, -1, 0, 5, 71,  // He4_N13_to_p_O16_reaclib
        -1, 2, 5, -1, 0, 9, -1,  // C12_O16_to_p_Al27_reaclib
        -1, 2, 5, -1, 1, 8, -1,  // C12_O16_to_He4_Mg24_reaclib
        -1, 5, 5, -1, 0, 11, -1,  // O16_O16_to_p_P31_reaclib
        -1, 5, 5, -1, 1, 10, -1,  // O16_O16_to_He4_Si28_reaclib
        -1, 0, 7, -1, 1, 6, 72,  // p_Na23_to_He4_Ne20_reaclib
        -1, 0, 9, -1, 1, 8, 73,  // p_Al27_to_He4_Mg24_reaclib
        -1, 0, 11, -1, 1, 10, 74,  // p_P31_to_He4_Si28_reaclib
        1, 1, 1, -1, -1, 2, 70,  // He4_He4_He4_to_C12_reaclib
