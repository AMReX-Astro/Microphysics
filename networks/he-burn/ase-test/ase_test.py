...
def get_library():
    ...
    # Remove reaclib o16(p,g)f17 and its derived rate
    # and add IliadisO16pgF17 and its corresponding derived rate
    ...
    subch.add_rate(iliadis)
    subch.add_rate(iliadis_derived)
...
def create_network():
    ...
    net = AmrexAstroCxxNetwork(libraries=[subch], disable_rate_params=[r1, r2])
...
def doit():
    ...
    net.plot(rho, T, comp, outfile="ase_test.png",
