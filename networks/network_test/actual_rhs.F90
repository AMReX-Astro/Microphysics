...
contains
  ...
  subroutine evaluate_rates(state, rate_eval)
    ...
    print*, "rhs_Y(:) =",Y(:)
    print*, "rhs_rhoy =",rhoy
    print*, "rhs_state % xn(:) =",state % xn(:)
    print*, "rhs_aion_inv(:) =",aion_inv(:)
    print*, "rhs_state % rho =",state % rho
    print*, "rhs_state % y_e =",state % y_e
  ...
  subroutine rhs_nuc(state, ydot_nuc, Y, screened_rates)
    ...
    scratch_0 = screened_rates(k_ne20__f20)*Y(jne20)
