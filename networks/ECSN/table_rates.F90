...
contains
  ...
  subroutine init_tabular()
    ...
    call init_tab_info(rate_table_j_f20_o20, rhoy_table_j_f20_o20, temp_table_j_f20_o20, num_rhoy_j_f20_o20, num_temp_j_f20_o20, num_vars_j_f20_o20, rate_table_file_j_f20_o20, num_header_j_f20_o20)
    ...
    call init_tab_info(rate_table_j_ne20_f20, rhoy_table_j_ne20_f20, temp_table_j_ne20_f20, num_rhoy_j_ne20_f20, num_temp_j_ne20_f20, num_vars_j_ne20_f20, rate_table_file_j_ne20_f20, num_header_j_ne20_f20)
    ...
    call init_tab_info(rate_table_j_o20_f20, rhoy_table_j_o20_f20, temp_table_j_o20_f20, num_rhoy_j_o20_f20, num_temp_j_o20_f20, num_vars_j_o20_f20, rate_table_file_j_o20_f20, num_header_j_o20_f20)

    allocate(num_temp_j_f20_ne20)
    allocate(num_rhoy_j_f20_ne20)
    allocate(num_vars_j_f20_ne20)
    num_temp_j_f20_ne20 = 39
  ...
  subroutine term_table_meta()
    ...
    deallocate(num_vars_j_f20_ne20)
