...
contains
  ...
  subroutine actual_network_init()
    ...
    ebind_per_nucleon(jli6)   = 5.33233100000000d+00
    ebind_per_nucleon(jli7)   = 5.60643900000000d+00
    ebind_per_nucleon(jbe7)   = 5.37154800000000d+00
    ebind_per_nucleon(jbe9)   = 6.46266800000000d+00
    ebind_per_nucleon(jb8)   = 4.71715500000000d+00
    ebind_per_nucleon(jb10)   = 6.47508300000000d+00
    ebind_per_nucleon(jb11)   = 6.92773200000000d+00
    ...
    ebind_per_nucleon(jsi31)   = 8.45829100000000d+00
    ebind_per_nucleon(jsi32)   = 8.48146800000000d+00
    ...
    ebind_per_nucleon(js36)   = 8.57538900000000d+00
    ...
    ebind_per_nucleon(jar40)   = 8.59525900000000d+00
    ...
    ebind_per_nucleon(jca45)   = 8.63054500000000d+00
    ebind_per_nucleon(jca46)   = 8.66897900000000d+00
    ebind_per_nucleon(jca47)   = 8.63934900000000d+00
    ebind_per_nucleon(jca48)   = 8.66668600000000d+00
    ...
    ebind_per_nucleon(jsc47)   = 8.66509000000000d+00
    ebind_per_nucleon(jsc48)   = 8.65620400000000d+00
    ebind_per_nucleon(jsc49)   = 8.68625600000000d+00
    ...
    ebind_per_nucleon(jti49)   = 8.71115700000000d+00
    ebind_per_nucleon(jti50)   = 8.75571800000000d+00
    ebind_per_nucleon(jti51)   = 8.70898800000000d+00
    ...
    ebind_per_nucleon(jv51)   = 8.74209900000000d+00
    ebind_per_nucleon(jv52)   = 8.71458200000000d+00
    ...
    ebind_per_nucleon(jcr53)   = 8.76019800000000d+00
    ebind_per_nucleon(jcr54)   = 8.77795500000000d+00
    ...
    ebind_per_nucleon(jfe57)   = 8.77027900000000d+00
    ebind_per_nucleon(jfe58)   = 8.79225000000000d+00
    ...
    ebind_per_nucleon(jco57)   = 8.74188200000000d+00
    ebind_per_nucleon(jco58)   = 8.73896900000000d+00
    ebind_per_nucleon(jco59)   = 8.76803500000000d+00
    ebind_per_nucleon(jni56)   = 8.64277900000000d+00
    ebind_per_nucleon(jni57)   = 8.67093300000000d+00
    ebind_per_nucleon(jni58)   = 8.73205900000000d+00
    ebind_per_nucleon(jni59)   = 8.73658800000000d+00
    ebind_per_nucleon(jni60)   = 8.78077400000000d+00
    ebind_per_nucleon(jni61)   = 8.76502500000000d+00
    ebind_per_nucleon(jni62)   = 8.79455300000000d+00
    ebind_per_nucleon(jni63)   = 8.76349300000000d+00
    ebind_per_nucleon(jni64)   = 8.77746100000000d+00
    ebind_per_nucleon(jcu57)   = 8.50326200000000d+00
    ebind_per_nucleon(jcu58)   = 8.57096700000000d+00
    ebind_per_nucleon(jcu59)   = 8.64200000000000d+00
    ebind_per_nucleon(jcu60)   = 8.66560200000000d+00
    ebind_per_nucleon(jcu61)   = 8.71551400000000d+00
    ebind_per_nucleon(jcu62)   = 8.71808100000000d+00
    ebind_per_nucleon(jcu63)   = 8.75213800000000d+00
    ebind_per_nucleon(jcu64)   = 8.73907500000000d+00
    ebind_per_nucleon(jcu65)   = 8.75709600000000d+00
    ebind_per_nucleon(jzn59)   = 8.47377700000000d+00
    ebind_per_nucleon(jzn60)   = 8.58305000000000d+00
    ebind_per_nucleon(jzn61)   = 8.61030900000000d+00
    ebind_per_nucleon(jzn62)   = 8.67934300000000d+00
    ebind_per_nucleon(jzn63)   = 8.68628500000000d+00
    ebind_per_nucleon(jzn64)   = 8.73590500000000d+00
    ebind_per_nucleon(jzn65)   = 8.72426500000000d+00
    ebind_per_nucleon(jzn66)   = 8.75963200000000d+00
    ebind_per_nucleon(jga62)   = 8.51864200000000d+00
    ebind_per_nucleon(jga63)   = 8.58392600000000d+00
    ebind_per_nucleon(jga64)   = 8.61163100000000d+00
    ebind_per_nucleon(jge63)   = 8.41871600000000d+00
    ebind_per_nucleon(jge64)   = 8.52882300000000d+00
    ...
    aion(jli6)   = 6.00000000000000d+00
    aion(jli7)   = 7.00000000000000d+00
    aion(jbe7)   = 7.00000000000000d+00
    aion(jbe9)   = 9.00000000000000d+00
    aion(jb8)   = 8.00000000000000d+00
    aion(jb10)   = 1.00000000000000d+01
    aion(jb11)   = 1.10000000000000d+01
    ...
    aion(jsi31)   = 3.10000000000000d+01
    aion(jsi32)   = 3.20000000000000d+01
    ...
    aion(js36)   = 3.60000000000000d+01
    ...
    aion(jar40)   = 4.00000000000000d+01
    ...
    aion(jca45)   = 4.50000000000000d+01
    aion(jca46)   = 4.60000000000000d+01
    aion(jca47)   = 4.70000000000000d+01
    aion(jca48)   = 4.80000000000000d+01
    ...
    aion(jsc47)   = 4.70000000000000d+01
    aion(jsc48)   = 4.80000000000000d+01
    aion(jsc49)   = 4.90000000000000d+01
    ...
    aion(jti49)   = 4.90000000000000d+01
    aion(jti50)   = 5.00000000000000d+01
    aion(jti51)   = 5.10000000000000d+01
    ...
    aion(jv51)   = 5.10000000000000d+01
    aion(jv52)   = 5.20000000000000d+01
    ...
    aion(jcr53)   = 5.30000000000000d+01
    aion(jcr54)   = 5.40000000000000d+01
    ...
    aion(jfe57)   = 5.70000000000000d+01
    aion(jfe58)   = 5.80000000000000d+01
    ...
    aion(jco57)   = 5.70000000000000d+01
    aion(jco58)   = 5.80000000000000d+01
    aion(jco59)   = 5.90000000000000d+01
    aion(jni56)   = 5.60000000000000d+01
    aion(jni57)   = 5.70000000000000d+01
    aion(jni58)   = 5.80000000000000d+01
    aion(jni59)   = 5.90000000000000d+01
    aion(jni60)   = 6.00000000000000d+01
    aion(jni61)   = 6.10000000000000d+01
    aion(jni62)   = 6.20000000000000d+01
    aion(jni63)   = 6.30000000000000d+01
    aion(jni64)   = 6.40000000000000d+01
    aion(jcu57)   = 5.70000000000000d+01
    aion(jcu58)   = 5.80000000000000d+01
    aion(jcu59)   = 5.90000000000000d+01
    aion(jcu60)   = 6.00000000000000d+01
    aion(jcu61)   = 6.10000000000000d+01
    aion(jcu62)   = 6.20000000000000d+01
    aion(jcu63)   = 6.30000000000000d+01
    aion(jcu64)   = 6.40000000000000d+01
    aion(jcu65)   = 6.50000000000000d+01
    aion(jzn59)   = 5.90000000000000d+01
    aion(jzn60)   = 6.00000000000000d+01
    aion(jzn61)   = 6.10000000000000d+01
    aion(jzn62)   = 6.20000000000000d+01
    aion(jzn63)   = 6.30000000000000d+01
    aion(jzn64)   = 6.40000000000000d+01
    aion(jzn65)   = 6.50000000000000d+01
    aion(jzn66)   = 6.60000000000000d+01
    aion(jga62)   = 6.20000000000000d+01
    aion(jga63)   = 6.30000000000000d+01
    aion(jga64)   = 6.40000000000000d+01
    aion(jge63)   = 6.30000000000000d+01
    aion(jge64)   = 6.40000000000000d+01
    ...
    zion(jli6)   = 3.00000000000000d+00
    zion(jli7)   = 3.00000000000000d+00
    zion(jbe7)   = 4.00000000000000d+00
    zion(jbe9)   = 4.00000000000000d+00
    zion(jb8)   = 5.00000000000000d+00
    zion(jb10)   = 5.00000000000000d+00
    zion(jb11)   = 5.00000000000000d+00
    ...
    zion(jsi31)   = 1.40000000000000d+01
    zion(jsi32)   = 1.40000000000000d+01
    ...
    zion(js36)   = 1.60000000000000d+01
    ...
    zion(jar40)   = 1.80000000000000d+01
    ...
    zion(jca45)   = 2.00000000000000d+01
    zion(jca46)   = 2.00000000000000d+01
    zion(jca47)   = 2.00000000000000d+01
    zion(jca48)   = 2.00000000000000d+01
    ...
    zion(jsc47)   = 2.10000000000000d+01
    zion(jsc48)   = 2.10000000000000d+01
    zion(jsc49)   = 2.10000000000000d+01
    ...
    zion(jti49)   = 2.20000000000000d+01
    zion(jti50)   = 2.20000000000000d+01
    zion(jti51)   = 2.20000000000000d+01
    ...
    zion(jv51)   = 2.30000000000000d+01
    zion(jv52)   = 2.30000000000000d+01
    ...
    zion(jcr53)   = 2.40000000000000d+01
    zion(jcr54)   = 2.40000000000000d+01
    ...
    zion(jfe57)   = 2.60000000000000d+01
    zion(jfe58)   = 2.60000000000000d+01
    ...
    zion(jco57)   = 2.70000000000000d+01
    zion(jco58)   = 2.70000000000000d+01
    zion(jco59)   = 2.70000000000000d+01
    zion(jni56)   = 2.80000000000000d+01
    zion(jni57)   = 2.80000000000000d+01
    zion(jni58)   = 2.80000000000000d+01
    zion(jni59)   = 2.80000000000000d+01
    zion(jni60)   = 2.80000000000000d+01
    zion(jni61)   = 2.80000000000000d+01
    zion(jni62)   = 2.80000000000000d+01
    zion(jni63)   = 2.80000000000000d+01
    zion(jni64)   = 2.80000000000000d+01
    zion(jcu57)   = 2.90000000000000d+01
    zion(jcu58)   = 2.90000000000000d+01
    zion(jcu59)   = 2.90000000000000d+01
    zion(jcu60)   = 2.90000000000000d+01
    zion(jcu61)   = 2.90000000000000d+01
    zion(jcu62)   = 2.90000000000000d+01
    zion(jcu63)   = 2.90000000000000d+01
    zion(jcu64)   = 2.90000000000000d+01
    zion(jcu65)   = 2.90000000000000d+01
    zion(jzn59)   = 3.00000000000000d+01
    zion(jzn60)   = 3.00000000000000d+01
    zion(jzn61)   = 3.00000000000000d+01
    zion(jzn62)   = 3.00000000000000d+01
    zion(jzn63)   = 3.00000000000000d+01
    zion(jzn64)   = 3.00000000000000d+01
    zion(jzn65)   = 3.00000000000000d+01
    zion(jzn66)   = 3.00000000000000d+01
    zion(jga62)   = 3.10000000000000d+01
    zion(jga63)   = 3.10000000000000d+01
    zion(jga64)   = 3.10000000000000d+01
    zion(jge63)   = 3.20000000000000d+01
    zion(jge64)   = 3.20000000000000d+01
    ...
    nion(jli6)   = 3.00000000000000d+00
    nion(jli7)   = 4.00000000000000d+00
    nion(jbe7)   = 3.00000000000000d+00
    nion(jbe9)   = 5.00000000000000d+00
    nion(jb8)   = 3.00000000000000d+00
    nion(jb10)   = 5.00000000000000d+00
    nion(jb11)   = 6.00000000000000d+00
    ...
    nion(jsi31)   = 1.70000000000000d+01
    nion(jsi32)   = 1.80000000000000d+01
    ...
    nion(js36)   = 2.00000000000000d+01
    ...
    nion(jar40)   = 2.20000000000000d+01
    ...
    nion(jca45)   = 2.50000000000000d+01
    nion(jca46)   = 2.60000000000000d+01
    nion(jca47)   = 2.70000000000000d+01
    nion(jca48)   = 2.80000000000000d+01
    ...
    nion(jsc47)   = 2.60000000000000d+01
    nion(jsc48)   = 2.70000000000000d+01
    nion(jsc49)   = 2.80000000000000d+01
    ...
    nion(jti49)   = 2.70000000000000d+01
    nion(jti50)   = 2.80000000000000d+01
    nion(jti51)   = 2.90000000000000d+01
    ...
    nion(jv51)   = 2.80000000000000d+01
    nion(jv52)   = 2.90000000000000d+01
    ...
    nion(jcr53)   = 2.90000000000000d+01
    nion(jcr54)   = 3.00000000000000d+01
    ...
    nion(jfe57)   = 3.10000000000000d+01
    nion(jfe58)   = 3.20000000000000d+01
    ...
    nion(jco57)   = 3.00000000000000d+01
    nion(jco58)   = 3.10000000000000d+01
    nion(jco59)   = 3.20000000000000d+01
    nion(jni56)   = 2.80000000000000d+01
    nion(jni57)   = 2.90000000000000d+01
    nion(jni58)   = 3.00000000000000d+01
    nion(jni59)   = 3.10000000000000d+01
    nion(jni60)   = 3.20000000000000d+01
    nion(jni61)   = 3.30000000000000d+01
    nion(jni62)   = 3.40000000000000d+01
    nion(jni63)   = 3.50000000000000d+01
    nion(jni64)   = 3.60000000000000d+01
    nion(jcu57)   = 2.80000000000000d+01
    nion(jcu58)   = 2.90000000000000d+01
    nion(jcu59)   = 3.00000000000000d+01
    nion(jcu60)   = 3.10000000000000d+01
    nion(jcu61)   = 3.20000000000000d+01
    nion(jcu62)   = 3.30000000000000d+01
    nion(jcu63)   = 3.40000000000000d+01
    nion(jcu64)   = 3.50000000000000d+01
    nion(jcu65)   = 3.60000000000000d+01
    nion(jzn59)   = 2.90000000000000d+01
    nion(jzn60)   = 3.00000000000000d+01
    nion(jzn61)   = 3.10000000000000d+01
    nion(jzn62)   = 3.20000000000000d+01
    nion(jzn63)   = 3.30000000000000d+01
    nion(jzn64)   = 3.40000000000000d+01
    nion(jzn65)   = 3.50000000000000d+01
    nion(jzn66)   = 3.60000000000000d+01
    nion(jga62)   = 3.10000000000000d+01
    nion(jga63)   = 3.20000000000000d+01
    nion(jga64)   = 3.30000000000000d+01
    nion(jge63)   = 3.10000000000000d+01
    nion(jge64)   = 3.20000000000000d+01
