...
c     begin initialization
     ...
     1     helium(46221), sica(46221), fegroup(46221),
     2     abartab(46221),ebtab(46221),wratetab(46221)
...
c     read in table
      ...
      read (2,5) ttlog(j),ddlog(j),yetab(j),helium(j),sica(j),
     1     fegroup(j), abartab(j), ebtab(j),wratetab(j)
