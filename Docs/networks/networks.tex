...
with the initial temperature, density, and composition.  As the system
is integrated, this thermodynamic consistency will no longer be
maintained (because density doesn't evolve and the $T$ evolution is
approximate) but $e$ will represent an approximation to the
current specific internal energy, including the nuclear energy
generation release. 
