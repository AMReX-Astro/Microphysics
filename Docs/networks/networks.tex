...
latter upper limit is arbirary, but is safe for the types of problems
...
as much metadata as some other integrators.  The fields of {\tt upar}
are:
\begin{itemize}
...
\mathcal{O}(1)$.  \MarginPar{does anyone use this?}
