...
+---------------------------------------+---------------------------------------------------------+------------------------------+
| ``retry_rtol_spec``                   | Tolerances for the solver (relative and absolute), for  | 1.e-12                       |
|                                       | the species and energy equations.                       |                              |
+---------------------------------------+---------------------------------------------------------+------------------------------+
...
|                                       | initial energy?                                         |                              |
+---------------------------------------+---------------------------------------------------------+------------------------------+
| ``nse_iters``                         | for the NSE update predictor-corrector, how many        | 3                            |
|                                       | iterations do we take to get the new time NSE state     |                              |
+---------------------------------------+---------------------------------------------------------+------------------------------+
