...
100 continue
  ...
  subroutine DGBFA (ABD, LDA, ML, MU, IPVT, INFO)
    ...
    ! ***CATEGORY  D2A2
    ! ***TYPE      real(rt) (SGBFA-S, DGBFA-D, CGBFA-C)
    ! ***KEYWORDS  BANDED, LINEAR ALGEBRA, LINPACK, MATRIX FACTORIZATION
    ! ***AUTHOR  Moler, C. B., (U. of New Mexico)
    ! ***DESCRIPTION
    ! 
    !      DGBFA factors a real(rt) band matrix by elimination.
    ! 
...
130 CONTINUE
  ...
  SUBROUTINE DGBSL (ABD, LDA, ML, MU, IPVT, B, JOB)
    ...
    ! ***CATEGORY  D2A2
    ! ***TYPE      real(rt) (SGBSL-S, DGBSL-D, CGBSL-C)
    ! ***KEYWORDS  BANDED, LINEAR ALGEBRA, LINPACK, MATRIX, SOLVE
    ! ***AUTHOR  Moler, C. B., (U. of New Mexico)
    ! ***DESCRIPTION
    ! 
    !      DGBSL solves the real(rt) band system
    !      A * X = B  or  TRANS(A) * X = B
