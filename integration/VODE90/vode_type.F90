...
contains
  ...
  subroutine renormalize_species(y, rpar)
    ...
    use burn_type_module, only: neqs
    use cuvode_rpar_module, only: n_rpar_comps, irp_nspec, n_not_evolved
  ...
  subroutine update_thermodynamics(y, rpar)
    ...
    use cuvode_rpar_module, only: n_rpar_comps, irp_self_heat, irp_cp, irp_cv, irp_Told, irp_dcpdt, irp_dcvdt
    use burn_type_module, only: neqs
  ...
  subroutine vode_to_eos(state, y, rpar)
    ...
    use cuvode_rpar_module, only: irp_dens, irp_nspec, irp_cp, irp_cv, irp_abar, irp_zbar, &
